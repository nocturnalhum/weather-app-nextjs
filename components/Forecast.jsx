...
export default function Forecast({ forecast }) {
  ...
  return (
    <div className='h-full p-8  bg-gray-500 shadow-inner bg-clip-padding border-2 border-gray-600/70 backdrop-blur-sm border-r-gray-400 border-t-gray-500  rounded-2xl'>
